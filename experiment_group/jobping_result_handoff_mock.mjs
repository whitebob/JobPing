import { boxResult, unboxResult } from "./jobping_envelope_mock.mjs";
...
export class MockResultHandoff {
  constructor({ transportLayer }) {
    if (!transportLayer?.sendMessage || !transportLayer?.recvMessage) {
      throw new Error("MockResultHandoff requires a transport layer with sendMessage/recvMessage");
    }
