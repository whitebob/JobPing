// Simple Promise-based control client for the JobPing baseline experiment.
//
// This client intentionally does not use JobPing. It starts many concurrent
// requests and awaits the remote FastAPI endpoint directly.
...
const serverUrl = readOption("serverUrl", "http://127.0.0.1:8888");
...
async function runOneRequest(requestId) {
