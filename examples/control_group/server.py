"""Simple FastAPI control server for the JobPing baseline experiment.

This server intentionally does not use JobPing. Each request waits on the
remote application endpoint until the simulated work is done.
"""
...
app = FastAPI(title="JobPing control group")
...
async def reset_metrics() -> dict[str, str]:
    """Reset counters before a new control-group run."""
